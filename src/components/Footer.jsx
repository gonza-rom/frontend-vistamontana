            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">📞 +54 9 383 494-6767</p>
                        <p className="text-gray-400">✉️ info@vistamontana.com</p>
                    </div>
                    <div>
                        <h3 className="text-xl font-bold mb-4">Enlaces</h3>
                        <div className="space-y-2">
                            <a href="/alquileres" className="block text-gray-400 hover:text-white transition">Reservar</a>
                            <a href="/turismo" className="block text-gray-400 hover:text-white transition">Lugares turísticos</a>
                            <a href="/contacto" className="block text-gray-400 hover:text-white transition">Contacto</a>
                        </div>
                    </div>
                    <div>
